...
const PaymentProcessor = require('PaymentProcessor.json');
const { Payment } = require('./backend.js');
...
app.listen(4000, () => {
 ...
 const listenToEvents = () => {
     const provider = new ethers.provoders.JsonRpcProvider('http://localhost:9545');
